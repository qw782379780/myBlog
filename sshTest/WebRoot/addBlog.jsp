...
<html>
	...
	<body class="body">
		...
		<div class="input">
			<form
				action="${pageContext.request.contextPath}/Article_addBlog.action"
				method="post">

				<input name="author" type="hidden" value="${user.username}" />
				<br />
				<input id="title" class="title" name="title" type="text"
					placeholder="请输入标题" />
				<br />
				<div class="content">
					<script id="editor" type="text/plain" name="content" style="height:380px;"></script>
